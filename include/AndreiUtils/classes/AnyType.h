...
namespace AndreiUtils {
    ...
    protected:
        ...
        struct Holder : public PlaceHolder {
             ...
             * @brief Gets the type of the underlying value.
             */
            [[nodiscard]] std::type_info const &getType() const override { return typeid(ValueType); }

            /**
             * @brief Gets the type name of the underlying value.
             */
            [[nodiscard]] std::string getTypeName() const override { return typeid(ValueType).name(); }

            /**
             * @brief Clones the holder.
             */
            [[nodiscard]] PlaceHolder *clone() const override { return new Holder(held); }
