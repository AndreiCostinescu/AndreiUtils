...
void updateTime(const clock_t &newTime, clock_t &prevTime, bool updatePrevTime = false, float *difference = nullptr);

void updateTime(const clock_t &newTime, clock_t &prevTime, bool updatePrevTime = false, double *difference = nullptr);
