...
std::vector<Posed> const &Grasp::getGraspPointPoses() const {
    return this->graspPointPoses;
}
...
std::pair<double, double> const &Grasp::getGraspAngleRange() const {
    return this->graspAngleRange;
}

std::pair<double, double> &Grasp::getGraspAngleRange() {
    return this->graspAngleRange;
}
